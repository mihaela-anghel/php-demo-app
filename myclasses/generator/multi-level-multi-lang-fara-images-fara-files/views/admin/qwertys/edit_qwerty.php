...
<table class="form_table" width="<?php echo $table_width?>">  
	<tr>
		<th width="<?php echo $th_width?>">
			<?php echo $this->lang->line("qwerty")?>
		</th>
		<td>
            ...
            <select name="parent_id" class="select">
                ...
                <?php	
                foreach($qwertys_tree as $option)
                {                  
                    if($option['qwerty_id'] == $qwerty['parent_id']) $selected = TRUE; else $selected = FALSE;
					?><option value="<?php echo $option['qwerty_id']?>" <?php echo set_select('parent_id',$option['qwerty_id'],$selected); ?>><?php for($i = 0; $i < ($option['level']*1) ; $i++) echo "&nbsp;";  echo $option['name']?></option><?php
                }
                ?>
            </select>
		</td>
    ...
    <div id="array_div_<?php echo $key?>" style="clear:left; display:<?php if($key == 0) echo "block"; else echo "none";?>" >	
		...
		<div style="clear:left;">
            <table class="form_table tab" width="<?php echo $table_width?>">
                <tr>
                    <th width="<?php echo $th_width?>">
                        <?php echo $this->lang->line("qwerty_name").$label_language?>
                    </th>
                    <td>
                        <input type="text" name="name[<?php echo $language["lang_id"]; ?>]" id="name_<?php echo $language["lang_id"]; ?>" value="<?php echo set_value("name[".$language["lang_id"]."]",(isset($qwerty_details["name"][$language["lang_id"]])?$qwerty_details["name"][$language["lang_id"]]:"")); ?>" style="width:600px;"/>*
                    </td>
                </tr> 
                <tr>
                    <th>
                        <?php echo $this->lang->line("qwerty_abstract").$label_language?>
                    </th>
                    <td>
                    	<textarea name="abstract[<?php echo $language["lang_id"]; ?>]" id="abstract_<?php echo $language["lang_id"]; ?>" rows="4" style="width:600px;"><?php echo set_value("abstract[".$language["lang_id"]."]",(isset($qwerty_details["abstract"][$language["lang_id"]])?$qwerty_details["abstract"][$language["lang_id"]]:"")); ?></textarea>                        						
                    </td>
                </tr> 
                <tr>
                    <th>
                        <?php echo $this->lang->line("qwerty_description").$label_language?>
                    </th>
                    <td>
                    	<textarea name="description[<?php echo $language["lang_id"]; ?>]" id="description_<?php echo $language["lang_id"]; ?>" rows="4" class="html_textarea" style="width:600px; height:300px"><?php echo set_value("description[".$language["lang_id"]."]",(isset($qwerty_details["description"][$language["lang_id"]])?$qwerty_details["description"][$language["lang_id"]]:"")); ?></textarea>                        						
                    </td>
                </tr> 
                <tr>
                    <th>
                    ...
                    <td>
                        <input type="text" name="meta_title[<?php echo $language["lang_id"]; ?>]" id="meta_title_<?php echo $language["lang_id"]; ?>" value="<?php echo set_value("meta_title[".$language["lang_id"]."]",(isset($qwerty_details["meta_title"][$language["lang_id"]])?$qwerty_details["meta_title"][$language["lang_id"]]:"")); ?>" style="width:600px;"/>
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                    	<textarea name="meta_description[<?php echo $language["lang_id"]; ?>]" id="meta_description_<?php echo $language["lang_id"]; ?>" rows="4" style="width:600px;"><?php echo set_value("meta_description[".$language["lang_id"]."]",(isset($qwerty_details["meta_description"][$language["lang_id"]])?$qwerty_details["meta_description"][$language["lang_id"]]:"")); ?></textarea>                        						
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                    	<textarea name="meta_keywords[<?php echo $language["lang_id"]; ?>]" id="meta_keywords_<?php echo $language["lang_id"]; ?>" rows="4" style="width:600px;"><?php echo set_value("meta_keywords[".$language["lang_id"]."]",(isset($qwerty_details["meta_keywords"][$language["lang_id"]])?$qwerty_details["meta_keywords"][$language["lang_id"]]:"")); ?></textarea>                        						
                    </td>
                </tr>					
            </table>
		</div> 
