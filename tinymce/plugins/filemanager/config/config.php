...
$project_dir 	= str_replace("/tinymce/plugins/filemanager","",$path_parts["dirname"]);
...
$config = array(
	...
	|
	*/
	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://". @$_SERVER['HTTP_HOST'].$project_dir,
	/*
	|--------------------------------------------------------------------------
	...
	|
	*/
	'upload_dir' => "/uploads/tinymce/files/",
	/*
	|--------------------------------------------------------------------------
	...
	|
	*/
	'current_path' => "../../../uploads/tinymce/files/",
	...
	|
	*/
	'thumbs_base_path' => "../../../uploads/tinymce/thumbs/",
