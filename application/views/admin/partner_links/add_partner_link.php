...
<form action="" method="post" enctype="multipart/form-data">
    <table class="form_table" width="<?php echo $table_width?>">       
        <tr>
            ...
            <td>
                <input type="radio" name="type" value="script" <?php echo set_radio('type', 'script',TRUE)?> onclick="show_div(vector_page,'div_script_type') " /><?php echo $this->lang->line('partner_link_script_type')?>
                <input type="radio" name="type" value="file" <?php echo set_radio('type', 'file')?> onclick="show_div(vector_page,'div_file_type') " /><?php echo $this->lang->line('partner_link_file_type')?>
            </td>
        </tr> 
    </table>

    <table class="form_table" width="<?php echo $table_width?>" id="div_file_type" style="display:<?php if(( isset($_POST['type']) && $_POST['type'] == 'file')) echo 'block'; else echo 'none';?>">
        <tr>
    ...
    <table class="form_table" width="<?php echo $table_width?>" id="div_script_type" style="display:<?php if((isset($_POST['type']) && $_POST['type'] == 'script') || !isset($_POST['type'])) echo 'block'; else echo 'none';?>">
        <tr>
            <th width="<?php echo $th_width?>">
            ...
            <td>
                ...
                <textarea name="script" style="width:600px;" ><?php echo  set_value('partner_link_script')?></textarea>
            </td>
        </tr> 
    </table>  
