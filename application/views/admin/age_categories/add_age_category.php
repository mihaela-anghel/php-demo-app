...
<table class="form_table" width="<?php echo $table_width?>"> 
    <tr style="display:none">
        ...
        <td>
            ...
            {
                for($i = 0; $i < ($age_category['level']*6) ; $i++)	$level .= "&nbsp;";	
                ?><option value="<?php echo $age_category['age_category_id']?>" <?php echo set_select('parent_id',$age_category['age_category_id']); ?>><?php for($i = 0; $i < ($age_category['level']*1) ; $i++) echo "---";  echo $age_category['age_category_name']?></option><?php
            }
            ?>
            </select>
	...
	<tr>
        ...
        <td>
			...
			<input type="text" name="min_age" value="<?php echo set_value('min_age'); ?>" style="width:42px;"/>	-
			<input type="text" name="max_age" value="<?php echo set_value('max_age'); ?>" style="width:42px;"/>	
