...
<table class="form_table" width="<?php echo $table_width?>">  
	<tr>		
		...
		<td>
            ...
            <select name="parent_id" class="select">
                ...
                {                  
                    if($option['page_id'] == $page['parent_id']) $selected = TRUE; else $selected = FALSE;
					?><option value="<?php echo $option['page_id']?>" <?php echo set_select('parent_id',$option['page_id'],$selected); ?>><?php for($i = 0; $i < ($option['level']*5) ; $i++) echo "&nbsp;";  echo $option['name']?></option><?php
                }
                ?>
            </select>
		</td>
	...
	<tr>
		...
		<td>
			...
			{
				if($page["active"] == $value) $selected = true; else $selected = false;
		...
		<div style="clear:left;">
            <table class="form_table tab" width="<?php echo $table_width?>">
                <tr>
                    ...
                    <td>
                        <input type="text" name="name[<?php echo $language["lang_id"]; ?>]" id="name_<?php echo $language["lang_id"]; ?>" value="<?php echo set_value("name[".$language["lang_id"]."]",(isset($page_details["name"][$language["lang_id"]])?$page_details["name"][$language["lang_id"]]:"")); ?>" style="width:600px;"/>*
                    </td>
                </tr>                                               				                 
                <!-- <tr>
                    <th>
                    ...
                    <td>
                    	<textarea name="abstract[<?php echo $language["lang_id"]; ?>]" id="abstract_<?php echo $language["lang_id"]; ?>" rows="4" style="width:600px;"><?php echo set_value("abstract[".$language["lang_id"]."]",(isset($page_details["abstract"][$language["lang_id"]])?$page_details["abstract"][$language["lang_id"]]:"")); ?></textarea>                        						
                    </td>
                </tr> --> 
                <tr>
                    <th>
                    ...
                    <td>
                    	<textarea name="description[<?php echo $language["lang_id"]; ?>]" id="description_<?php echo $language["lang_id"]; ?>" rows="4" class="html_textarea" style="width:600px; height:300px"><?php echo set_value("description[".$language["lang_id"]."]",(isset($page_details["description"][$language["lang_id"]])?$page_details["description"][$language["lang_id"]]:"")); ?></textarea>                        						
                    </td>
                </tr> 
                <tr>
                    <th>
                    ...
                    <td>
                        <input type="text" name="meta_title[<?php echo $language["lang_id"]; ?>]" id="meta_title_<?php echo $language["lang_id"]; ?>" value="<?php echo set_value("meta_title[".$language["lang_id"]."]",(isset($page_details["meta_title"][$language["lang_id"]])?$page_details["meta_title"][$language["lang_id"]]:"")); ?>" style="width:600px;"/>
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                    	<textarea name="meta_description[<?php echo $language["lang_id"]; ?>]" id="meta_description_<?php echo $language["lang_id"]; ?>" rows="4" style="width:600px;"><?php echo set_value("meta_description[".$language["lang_id"]."]",(isset($page_details["meta_description"][$language["lang_id"]])?$page_details["meta_description"][$language["lang_id"]]:"")); ?></textarea>                        						
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                    	<textarea name="meta_keywords[<?php echo $language["lang_id"]; ?>]" id="meta_keywords_<?php echo $language["lang_id"]; ?>" rows="4" style="width:600px;"><?php echo set_value("meta_keywords[".$language["lang_id"]."]",(isset($page_details["meta_keywords"][$language["lang_id"]])?$page_details["meta_keywords"][$language["lang_id"]]:"")); ?></textarea>                        						
                    </td>
                </tr>					
            </table>
		</div> 
