...
<table class="form_table" width="<?php echo $table_width?>"> 
	<tr>
		...
		<td>
			...
			{
				$selected = ($label==current($this->prize_types)?true:false);
		...
		<div style="clear:left;">
			<table class="form_table tab" width="<?php echo $table_width?>">
				<tr>
                    ...
                    <td>
                    	<input type="text" name="certificate[<?php echo $language['lang_id']; ?>]" id="certificate_<?php echo $language['lang_id']; ?>" value="<?php echo set_value('certificate['.$language['lang_id'].']'); ?>"/>
                    </td>
                </tr> 
                <tr>
                    <th width="<?php echo $th_width?>"><?php echo $this->lang->line('prize_name').$label_language?></th>
                    <td>
                    	<input type="text" name="name[<?php echo $language['lang_id']; ?>]" id="name_<?php echo $language['lang_id']; ?>" value="<?php echo set_value('name['.$language['lang_id'].']'); ?>"/>
                    </td>
                </tr>   
				<tr>
                    <th>
                    ...
                    <td height="200">
                    	<textarea name="email_content[<?php echo $language["lang_id"]; ?>]" id="email_content_<?php echo $language["lang_id"]; ?>" rows="4" class="html_textarea" style="width:600px; height:100px"><?php echo set_value("email_content[".$language["lang_id"]."]"); ?></textarea>                        						
                    </td>
				</tr>
