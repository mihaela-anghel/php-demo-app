...
<table class="form_table" width="<?php echo $table_width?>"> 
	...
	<tr>
		<th width="<?php echo $th_width?>">
			<?php echo $this->lang->line("participant_project_link_extern")?>
		</th>
		<td>
			<?php echo form_error("project_link_extern");?>
			<input type="text" name="project_link_extern" value="<?php echo set_value("project_link_extern",$participant["project_link_extern"]);?>">
		</td>
	</tr> 
    <tr>
        <th width="<?php echo $th_width?>">
