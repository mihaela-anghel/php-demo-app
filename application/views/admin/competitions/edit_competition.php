...
<table class="form_table" width="<?php echo $table_width?>">  		
	<tr>
		...
		<td>
			...
			{
				$selected = ($value==$competition["type"]?true:false);
	...
	<tr>
		...
		<td>
			...
			{
				$checked = (in_array($age_category["age_category_id"], $competition["age_category_ids"])?true:false);
				?>
	...
	<tr>
		...
		<td>
			...
			{
				$checked = (in_array($category["category_id"], $competition["category_ids"])?true:false);
				?>
				<span style="margin-right:20px">
	...
	<tr>
		...
		<td>
			...
			<input type="text" name="start_registration_date" value="<?php echo set_value("start_registration_date",$competition["start_registration_date"]); ?>" readonly="readonly" style="width:100px"/>*
			
			&nbsp;&nbsp;&nbsp;
			<?php echo $this->lang->line("competition_end_registration_date")?>			
			<input type="text" name="end_registration_date" value="<?php echo set_value("end_registration_date",$competition["end_registration_date"]); ?>" readonly="readonly" style="width:100px"/>*						
		</td>
	</tr>
	<tr>
		<th>
		...
		<td>
			...
			<input type="text" name="show_results_date" value="<?php echo set_value("show_results_date",$competition["show_results_date"]); ?>" readonly="readonly" style="width:100px"/>*								

			<?php
			/*			
			&nbsp;&nbsp;&nbsp;				
			<?php echo $this->lang->line("competition_end_submit_project_date")?>		
			<input type="text" name="end_submit_project_date" value="<?php echo set_value("end_submit_project_date",$competition["end_submit_project_date"]); ?>" readonly="readonly" style="width:100px"/>*				
			*/?>
		</td>
	</tr>
	<tr>
		...
		<td>
			...
			<input type="text" name="default_count_participants" value="<?php echo set_value("default_count_participants", $competition["default_count_participants"]); ?>" style="width:100px"/>*												
		</td>
	</tr>
	<tr>
		<th>
		...
		<td>
			...
			<input type="text" name="default_count_schools" value="<?php echo set_value("default_count_schools", $competition["default_count_schools"]); ?>" style="width:100px"/>*												
		</td>
	</tr>
	<tr>
		<th>
		...
		<td>
			...
			<input type="text" name="default_count_countries" value="<?php echo set_value("default_count_countries", $competition["default_count_countries"]); ?>" style="width:100px"/>*												
		</td>
	</tr>
    <tr>
		<th width="<?php echo $th_width?>">
		...
		<td>
			...
			{
				$selected = ($value==$competition["popup_info_active"]);
	...
	<tr>
		...
		<td>
			...
			{
				if($competition["active"] == $value) $selected = true; else $selected = false;
		...
		<div style="clear:left;">
            <table class="form_table tab" width="<?php echo $table_width?>">
                <tr>
                    ...
                    <td>
                        <input type="text" name="name[<?php echo $language["lang_id"]; ?>]" id="name_<?php echo $language["lang_id"]; ?>" value="<?php echo set_value("name[".$language["lang_id"]."]",(isset($competition_details["name"][$language["lang_id"]])?$competition_details["name"][$language["lang_id"]]:"")); ?>" style="width:600px;"/>*
                    </td>
                </tr>                
                <tr>
                    <th>
                    ...
                    <td>
                    	<textarea name="description[<?php echo $language["lang_id"]; ?>]" id="description_<?php echo $language["lang_id"]; ?>" rows="4" class="html_textarea" style="width:600px; height:300px"><?php echo set_value("description[".$language["lang_id"]."]",(isset($competition_details["description"][$language["lang_id"]])?$competition_details["description"][$language["lang_id"]]:"")); ?></textarea>                        						
                    </td>
				</tr> 
				<tr>
                    <th>
                    ...
                    <td>
                        <input type="text" name="theme_name[<?php echo $language["lang_id"]; ?>]" id="theme_name_<?php echo $language["lang_id"]; ?>" value="<?php echo set_value("theme_name[".$language["lang_id"]."]",(isset($competition_details["theme_name"][$language["lang_id"]])?$competition_details["theme_name"][$language["lang_id"]]:"")); ?>" style="width:600px;"/>*
                    </td>
                </tr>
				<tr>
                    <th>
                    ...
                    <td>
                    	<textarea name="theme_description[<?php echo $language["lang_id"]; ?>]" id="theme_description_<?php echo $language["lang_id"]; ?>" rows="4" class="html_textarea" style="width:600px;"><?php echo set_value("theme_description[".$language["lang_id"]."]",(isset($competition_details["theme_description"][$language["lang_id"]])?$competition_details["theme_description"][$language["lang_id"]]:"")); ?></textarea>                        						
                    </td>
				</tr>
				<tr>
                    <th>
                    ...
                    <td>
                    	<textarea name="code_language[<?php echo $language["lang_id"]; ?>]" id="code_language_<?php echo $language["lang_id"]; ?>" rows="4" class="html_textarea" style="width:600px; height:100px"><?php echo set_value("code_language[".$language["lang_id"]."]",(isset($competition_details["code_language"][$language["lang_id"]])?$competition_details["code_language"][$language["lang_id"]]:"")); ?></textarea>                        						
                    </td>
				</tr> 	
				<tr>
                    <th>
                    ...
                    <td>
                    	<textarea name="rules[<?php echo $language["lang_id"]; ?>]" id="rules_<?php echo $language["lang_id"]; ?>" rows="4" class="html_textarea" style="width:600px; height:300px"><?php echo set_value("rules[".$language["lang_id"]."]",(isset($competition_details["rules"][$language["lang_id"]])?$competition_details["rules"][$language["lang_id"]]:"")); ?></textarea>                        						
                    </td>
				</tr>
				<tr>
                    <th>
                    ...
                    <td>
                    	<textarea name="email_content[<?php echo $language["lang_id"]; ?>]" id="email_content_<?php echo $language["lang_id"]; ?>" rows="4" class="html_textarea" style="width:600px; height:300px"><?php echo set_value("email_content[".$language["lang_id"]."]",(isset($competition_details["email_content"][$language["lang_id"]])?$competition_details["email_content"][$language["lang_id"]]:"")); ?></textarea>                        						
                    </td>
				</tr>
                <tr>
                    <th>
                    ...
                    <td>
                    	<textarea name="popup_info[<?php echo $language["lang_id"]; ?>]" id="popup_info_<?php echo $language["lang_id"]; ?>" rows="4" class="html_textarea" style="width:600px; height:300px"><?php echo set_value("popup_info[".$language["lang_id"]."]",(isset($competition_details["popup_info"][$language["lang_id"]])?$competition_details["popup_info"][$language["lang_id"]]:"")); ?></textarea>                        						
                    </td>
				</tr>
                <tr>
                    <th>
                    ...
                    <td>
                        <input type="text" name="meta_title[<?php echo $language["lang_id"]; ?>]" id="meta_title_<?php echo $language["lang_id"]; ?>" value="<?php echo set_value("meta_title[".$language["lang_id"]."]",(isset($competition_details["meta_title"][$language["lang_id"]])?$competition_details["meta_title"][$language["lang_id"]]:"")); ?>" style="width:600px;"/>
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                    	<textarea name="meta_description[<?php echo $language["lang_id"]; ?>]" id="meta_description_<?php echo $language["lang_id"]; ?>" rows="4" style="width:600px;"><?php echo set_value("meta_description[".$language["lang_id"]."]",(isset($competition_details["meta_description"][$language["lang_id"]])?$competition_details["meta_description"][$language["lang_id"]]:"")); ?></textarea>                        						
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                    	<textarea name="meta_keywords[<?php echo $language["lang_id"]; ?>]" id="meta_keywords_<?php echo $language["lang_id"]; ?>" rows="4" style="width:600px;"><?php echo set_value("meta_keywords[".$language["lang_id"]."]",(isset($competition_details["meta_keywords"][$language["lang_id"]])?$competition_details["meta_keywords"][$language["lang_id"]]:"")); ?></textarea>                        						
                    </td>
                </tr>					
            </table>
		</div> 
