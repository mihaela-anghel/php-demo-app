...
$(document).ready(function() {
	$('#file').uploadifive({
		'uploadScript'    	: '<?php echo admin_url()?>competitions/videos_upload/<?php echo $competition['competition_id']?>',				
		'auto'      		: true,		
		'multi'     		: true,
...
<table class="list_table">
    <tr>
        <th><?php echo $this->lang->line('competition_video')?></th>
        <th><?php //echo $this->lang->line('competition_video_name')?></th>
        ...
        <tr>
            <td class="video" width="200">
                ...
                <video width="200" height="112" controls autoplay muted>
                    <source src="<?php echo file_url()?>uploads/competitions/videos/<?php echo $video['filename']?>?<?php echo uniqid('')?>" type="video/mp4">
                    Your browser does not support the video tag.
                </video>  
            </td>
            <td>   
                <span><?php echo $this->lang->line('competition_video_name')?></span>             
            ...
            <td>
                <input type="text" value="<?php echo $video["order"]?>" onblur="window.location='<?php echo admin_url()?>competitions/videos_change/<?php echo $video["video_id"] ?>/order/'+this.value" style="width:30px;"/>
            </td>            
            <td>
				<?php
                //active				
                $aux = array(	"field" 	=> "active",
                                ...
                                "url" 		=> admin_url()."competitions/videos_change/".$video["video_id"]	
                                );
            ...
            <td>	
                ...
                {
                    ?>
                    <a href="javascript:void(0)" onclick="if(confirm('<?php echo $this->lang->line("confirm_delete_file")?>')) window.location='<?php echo admin_url()?>competitions/videos_delete/<?php echo $video["video_id"] ?>'" class="delete">
