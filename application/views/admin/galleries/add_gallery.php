	...
	<tr>
        ...
        <td>	
            ...
            foreach($galleries_categories as $key=>$galleries_category)
            {
                ...
                ?><option value="<?php echo $galleries_category['galleries_category_id']?>" <?php echo set_select('galleries_category_id',$galleries_category['galleries_category_id']); ?>><?php echo $level.' '.$galleries_category['galleries_category_name']?></option><?php
            }	
            ?>
            </select>        
        </td>
