		...
		<div style="clear:left;">
            <table class="form_table tab" width="<?php echo $table_width?>">
                <tr>
                    ...
                    <td>
                        <input type="text" name="section_name[<?php echo $language["lang_id"]; ?>]" id="section_name_<?php echo $language["lang_id"]; ?>" value="<?php echo set_value("section_name[".$language["lang_id"]."]"); ?>"/>*
                    </td>
                </tr> 						
            </table>
		</div> 
...
<table class="form_table" width="<?php echo $table_width?>">  
	<tr>
		...
		<td>
            ...
            <input type="text" name="section_url" id="section_url" value="<?php echo set_value("section_url"); ?>"/>*
		</td>
	</tr>
	<tr>
		<th>
