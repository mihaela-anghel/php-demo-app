...
<table class="form_table" width="<?php echo $table_width?>"> 
    <tr style="display:none">
        ...
        <td>
            ...
            {
                for($i = 0; $i < ($galleries_category['level']*6) ; $i++)	$level .= "&nbsp;";	
                ?><option value="<?php echo $galleries_category['galleries_category_id']?>" <?php echo set_select('parent_id',$galleries_category['galleries_category_id']); ?>><?php for($i = 0; $i < ($galleries_category['level']*1) ; $i++) echo "---";  echo $galleries_category['galleries_category_name']?></option><?php
            }
            ?>
            </select>
