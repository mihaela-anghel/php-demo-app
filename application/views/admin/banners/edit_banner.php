...
<table class="form_table" width="<?php echo $table_width?>">
	<tr>
		...
		<td>
			...
			{
				if($banner["position"] == $value) $selected = true; else $selected = false;
    ...
    foreach($this->admin_languages as $language)
	{
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="name_<?php echo $language["code"]?>" id="name_<?php echo $language["code"]?>" value="<?php echo set_value("name_".$language["code"], $banner["name_".$language["code"]]); ?>" style="width:600px;"/>
            </td>
        </tr>
        <?php
		/*
        <tr>
            ...
            <td>
                ...
                <input type="text" name="subtitle_<?php echo $language["code"]?>" id="subtitle_<?php echo $language["code"]?>" value="<?php echo set_value("subtitle_".$language["code"], $banner["subtitle_".$language["code"]]); ?>" style="width:600px;"/>
            </td>
        </tr>
		*/?>
        <tr>
            ...
            <td>
                ...
                <textarea name="description_<?php echo $language["code"]?>" id="description_<?php echo $language["code"]?>" rows="4" class="html_textarea" style="width:600px; height:250px"><?php echo set_value("description_".$language["code"],$banner["description_".$language["code"]]); ?></textarea>                        						
            </td>
        </tr>
		<?php
	}	
    ...
    <tr>
        ...
        <td>
            ...
            <input type="text" name="url" id="url" value="<?php echo set_value("url", $banner["url"]); ?>" style="width:600px;"/>
        </td>
    </tr>         	    
	<tr>
		<th>
		...
		<td>
			...
			{
				if($banner["active"] == $value) $selected = true; else $selected = false;
