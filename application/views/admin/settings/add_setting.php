...
<table class="form_table" width="<?php echo $table_width?>"> 
    ...
    <tr>
        ...
        <td>
        	<input type="radio" name="is_multilanguage" value="0" onchange="show_div(vector_page,'div_setting')" <?php  echo set_radio('is_multilanguage', '0', TRUE); ?>/><?php echo $this->lang->line('no')?>
        	<input type="radio" name="is_multilanguage" value="1" onchange="show_div(vector_page,'div_details')" <?php  echo set_radio('is_multilanguage', '1'); ?>   /><?php echo $this->lang->line('yes')?>
        </td>
    </tr>
</table>
 
<div id = "div_setting" style="display:<?php if((isset($_POST['is_multilanguage']) && $_POST['is_multilanguage'] == '0') || !isset($_POST['is_multilanguage'])) echo 'block'; else echo 'none';?>">  
<!--FORM FIELDS THAT NOT DEPENDS ON LANGUGES-->
<table class="form_table" width="<?php echo $table_width?>"> 
    <tr>
        <th width="<?php echo $th_width?>">
...
<div id="div_details" style="display:<?php if(isset($_POST['is_multilanguage']) && $_POST['is_multilanguage'] == '1') echo 'block'; else echo 'none';?>"> 
	...
	?><div id="array_div_<?php echo $key?>" style="clear:left; display:<?php if($key == 0) echo 'block'; else echo 'none';?>" ><?php
		...
		<table class="form_table tab" width="<?php echo $table_width?>">
            <tr>
                ...
                <td>
                	<input type="text" name="description_details[<?php echo $language['lang_id']; ?>]" id="description_details_<?php echo $language['lang_id']; ?>" value="<?php echo set_value('description_details['.$language['lang_id'].']'); ?>"/>
                </td>
            </tr>   
            <tr>
                <th>
                ...
                <td>			
                	<textarea name="value_details[<?php echo $language['lang_id']; ?>]" id="value_details_<?php echo $language['lang_id']; ?>" style="width:300px; height:70px;"><?php echo set_value('value_details['.$language['lang_id'].']'); ?></textarea>
                </td>
            </tr>  			 
		</table>
		</div> 
