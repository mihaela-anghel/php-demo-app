...
<table class="form_table" width="<?php echo $table_width?>">  	
    <tr>
		...
		<td>
			...
			<input type="text" name="published_date" value="<?php echo set_value("published_date"); ?>" style="width:100px" readonly/>*	
	...
	<tr>
		...
		<td>
			...
			<input type="text" name="url" value="<?php echo set_value("url"); ?>" style="width:600px"/>			             
		</td>
	</tr>
    <tr>
		<th>
		...
		<td>
			...
			<textarea name="map" style="width:600px"><?php echo set_value("map"); ?></textarea>  
		</td>
	</tr> 
    */?>   
	<tr>
