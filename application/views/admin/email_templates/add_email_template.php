...
<table class="form_table" width="<?php echo $table_width?>">  	
	<tr>
        ...
        <td>
            ...
            <input type="text" name="identifier" id="identifier" value="<?php echo set_value("identifier"); ?>"/>
        </td>
    </tr>    		
</table>
		...
		<div style="clear:left;">
            <table class="form_table tab" width="<?php echo $table_width?>"> 
                ...
                <tr>
                    ...
                    <td>
                    	<textarea name="description[<?php echo $language["lang_id"]; ?>]" id="description_<?php echo $language["lang_id"]; ?>" class="html_textarea" rows="4" class="" style="width:600px; height:150px"><?php echo set_value("description[".$language["lang_id"]."]"); ?></textarea>                        						
                    </td>
                </tr>                 					
            </table>
		</div> 
