    ...
    <tr>
    	<th width="<?php echo $th_width?>">
   		...
   		<td>
            ...
            <input type="text" name="name" id="name" value="<?php echo set_value("name",$lang["name"]); ?>"/>*
		</td>
    </tr>  
    <tr>
    	<th>
   		...
   		<td>
            ...
            <input type="text" name="code" id="code" value="<?php echo set_value("code",$lang["code"]); ?>" maxlength="2"/>*
