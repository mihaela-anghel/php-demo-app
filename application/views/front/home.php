                        ...
                        if($current_competition["is_open_soon"])
                        {
                            ...
                            <div class="col-md-6">
                                <div>
                                    ...
                                    <div><small>Time zone: EE Bucharest (GMT+3)</small></div>
                                </div> 
                            </div>                            
                            <!-- register end -->
                            <?php
                    ...
                    if($current_competition["status"] == "close")
                    {
                        ...
                        <div class="col-md-6">  
                            ...
                            foreach($global_pages as $key=>$global_page)
                            {
                                ...
                                {
                                    ?>
                                    <a href="<?php echo $global_page["url"]."/".$current_competition['url_key']?>" class="btn btn-secondary btn-block">
    ...
    if($prizes_no)
    {
        ...
        <div class="row border border-light m-0 mb-4 p-3"> 
            <div class="col-12 p-0">
                <h3><?php echo $this->setting->item["competition_prizes_text_home"]; //$this->lang->line("competition_prizes")?></h3>
            </div>
            <?php                                   
            foreach($current_competition["prizes"] as $prize)
            {
        ...
        {                    
            ...
            <div class="col px-4">
                ...
                foreach($global_pages as $key=>$global_page)
                {
                    ...
                    {
                        ?>
                        <a href="<?php echo $global_page["url"]."/".$current_competition['url_key']?>" class="btn btn-secondary">
                            <?php echo $this->lang->line("results")?>
                        </a>
                        <?php 
                        break;                                           
