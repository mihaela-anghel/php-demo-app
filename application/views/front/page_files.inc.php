<?php
//files
if(isset($page["files"]) && $page["files"])
{
	?>		
	<div class="row bg-light mb-4 py-4">
		<div class="col-12">
			<h3><i class="far fa-folder-open"></i> <?php echo $this->lang->line("page_files")?></h3>
			...
			foreach($page["files"] as $file)
			{
				...
				$file_url		= $this->config->item('base_url').'uploads/pages/files/'.$file_name;
				$file_path 		= $this->config->item('base_path').'uploads/pages/files/'.$file_name;
